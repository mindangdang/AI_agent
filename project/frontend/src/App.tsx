    ...
    <div className="min-h-screen bg-[#FAFAFA] text-[#262626] font-sans flex">
      ...
      <nav className="w-20 md:w-64 border-r border-[#DBDBDB] h-screen sticky top-0 bg-white flex flex-col p-4">
        ...
        <div className="mt-auto space-y-2">
          <button 
            onClick={() => setActiveTab('profile')}
            className="flex items-center gap-4 p-3 w-full hover:bg-gray-50 rounded-lg transition-colors"
          >
          ...
          <button 
            ...
            className="flex items-center gap-4 p-3 w-full hover:bg-red-50 text-gray-500 hover:text-red-500 rounded-lg transition-colors"
          >
